...
class Santander240Registro3P(CNAB240Registro3):
    ...
    codigo_beneficiario = CNABFieldInteger(
        "", length=9, default="", required=True, value_from="conta"
    )
    codigo_beneficiario_dv = CNABFieldInteger(
        "", length=1, default="", required=True, value_from="conta_dv"
    )
    ...
    forma_cadastramento = CNABFieldInteger(
        "",
        length=1,
        default="1",
        required=True,
    )
    tipo_documento = CNABFieldInteger(
        "",
        length=1,
        default="1",
        required=True,
