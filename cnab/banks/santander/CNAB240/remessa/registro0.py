...
class Santander240Registro0(CNAB240Registro0):
    ...
    codigo_beneficiario_dv = CNABFieldInteger(
        "",
        length=1,
        default="0",
        required=True,
    ...
    nome_banco = CNABFieldAlfa(
        "",
        length=30,
        default="BANCO SANTANDER",
        required=True,
    )
    filler3 = CNABFieldAlfa(
        "",
        length=10,
        default=" ",
        required=True,
    )
    codigo_remessa = CNABFieldInteger(
        "",
        length=1,
        default="1",
        required=True,
    ...
    versao_layout = CNABFieldInteger(
        "",
        length=3,
        default="040",
        required=True,
