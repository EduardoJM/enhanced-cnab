...
class Caixa240Registro3Q(CNAB240Registro3):
    ...
    cep_pagador = CNABFieldInteger("",length=5, default="0", required=True)
    cep_sufixo = CNABFieldInteger("",length=3, default="0", required=True)
    ...
    numero_incricao_avalista = CNABFieldInteger("",length=15, default="0", required=True)
    nome_avalista = CNABFieldAlfa("",length=40, default=" ", required=True)
    codigo_banco_correspondente = CNABFieldInteger("",length=3, default="0", required=True)
    nosso_numero_banco_correspondente = CNABFieldAlfa("",length=20,default=" ",required=True)
