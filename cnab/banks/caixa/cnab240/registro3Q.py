...
class Caixa240Registro3Q(CNAB240Registro3):
    _meta = {
        ...
        "nome_avalista": CNABField(  # 19.3Q
            length=40, default=" ", validation=CNABFieldType.Alfa, required=True
        ),
        "codigo_banco_correspondente": CNABField(  # 20.3Q
            length=3, default="0", validation=CNABFieldType.Int, required=True
        ),
        "nosso_numero_banco_correspondente": CNABField(  # 21.3Q   Campo de preenchimento obrigatório; preencher com Seu Número de controle do título
            length=20,
            default=" ",  # este espaço foi colocado para passa a validação para os seters do generico
            validation=CNABFieldType.Alfa,
            required=True,
        ),
        "filler4": CNABField(  # 22.3Q
