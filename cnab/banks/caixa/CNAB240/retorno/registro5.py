...
class CaixaRetornoCnab240Registro5(Registro5Retorno):
    ...
    vrl_titulos_simples = CNABFieldDecimal("",length=15,default='0',precision=2,required=True)
    qtd_titulos_caucionada = CNABFieldInteger("",length=6,default='0',required=True)
    vlr_titulos_caucionada = CNABFieldDecimal("",length=15,default='0',precision=2,required=True)
    qtd_titulos_descontada = CNABFieldInteger("",length=6,default='0',required=True)
    vlr_titulos_descontada = CNABFieldDecimal("",length=15,default='0',precision=2,required=True)
