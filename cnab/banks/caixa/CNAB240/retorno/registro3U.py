...
class CaixaRetornoCnab240Registro3U(Registro3Retorno):
    ...
    vlr_juros_multa = CNABFieldDecimal(
        "", length=13, default="", precision=2, required=True
    )
    ...
    vlr_IOF = CNABFieldDecimal("", length=13, default="", precision=2, required=True)
    vlr_pago = CNABFieldDecimal("", length=13, default="", precision=2, required=True)
    ...
    vlr_outros_creditos = CNABFieldDecimal(
        "", length=13, default="", precision=2, required=True
    )
