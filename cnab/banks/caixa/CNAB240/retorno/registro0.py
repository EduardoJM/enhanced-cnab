...
class CaixaRetornoCnab240Registro0(Registro0Retorno):
    ...
    def inserir_detalhe(self):
        while self.file._lines_counter < len(self.file._lines) - 4:
            instance = CaixaRetornoCnab240Registro1(self.file, self.file._lines[self.file._lines_counter])
            instance.trailler = CaixaRetornoCnab240Registro5(self.file, self.file._lines[self.file._lines_counter])
