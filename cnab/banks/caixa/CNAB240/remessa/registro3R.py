...
class Caixa240Registro3R(CNAB240Registro3):
    ...
    vlr_desconto2 = CNABFieldDecimal("",length=13,default="0",precision=2,required=True)
    ...
    vlr_desconto3 = CNABFieldDecimal("",length=13,default="0",precision=2,required=True)
