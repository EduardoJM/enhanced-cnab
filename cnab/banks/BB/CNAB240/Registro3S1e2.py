...
class BancoBrasil240Registro3S1e2(CNAB240DetalheBase):
    _meta = {
        ...
        "filler": CNABField(  # 9.3S
            length=2, default="0", validation=CNABFieldType.Alfa, required=True
        ),
        "mensagem_140": CNABField(  # 10.3S
            length=140, default=" ", validation=CNABFieldType.Alfa, required=True
        ),
        "filler2": CNABField(  # 11.3S
            length=2, default="0", validation=CNABFieldType.Int, required=True
        ),
        "filler3": CNABField(  # 12.3S
            length=78, default=" ", validation=CNABFieldType.Alfa, required=True
        ),
    }
