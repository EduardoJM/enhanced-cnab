...
class ItauCnab400Registro1_2D(CNAB400Registro1):
    _meta = {
        ...
        "data_desconto2": CNABField(  # 31.3P
            length=6, default="0", validation=CNABFieldType.Date, required=True
        ),
        "vlr_desconto2": CNABField(  # 34.3P
            length=11,
            default="0",
            validation=CNABFieldType.Decimal,
            precision=2,
        ...
        "data_desconto3": CNABField(  # 31.3P
            length=6, default="0", validation=CNABFieldType.Date, required=True
        ),
        "vlr_desconto3": CNABField(  # 34.3P
            length=11,
            default="0",
            validation=CNABFieldType.Decimal,
            precision=2,
