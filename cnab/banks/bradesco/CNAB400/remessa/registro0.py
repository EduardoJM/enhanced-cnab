...
class BradescoCnab400Registro0(CNAB400Registro0):
    identificacao_registro = CNABFieldInteger(
        "001-001", length=1, default="0", required=True
    )
    operacao = CNABFieldInteger("002-002", length=1, default="1", required=True)
    literal_remessa = CNABFieldAlfa(
        "003-009", length=7, default="remessa", required=True
    )
    ...
    codigo_beneficiario = CNABFieldInteger(
        "027-046", length=20, default="", required=True
    )
    ...
    identificacao_sistema = CNABFieldAlfa(
        "109-110", length=2, default="MX", required=True
    )
    numero_sequencial_arquivo = CNABFieldInteger(
        "111-117", length=7, default="1", required=True
    )
    filler2 = CNABFieldAlfa("118-394", length=277, default=" ", required=True)
    numero_sequencial = CNABFieldInteger(
        "395-400", length=6, default="1", required=True
    )
