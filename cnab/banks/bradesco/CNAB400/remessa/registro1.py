...
class BradescoCnab400Registro1(CNAB400Registro1):
    ...
    digito_agencia_debito = CNABFieldInteger(
        "007-007", length=1, default="0", required=True
    )
    razao_conta_corrente_pagador = CNABFieldInteger(
        "008-012", length=5, default="0", required=True
    )
    conta_corrente_pagador = CNABFieldInteger(
        "013-019", length=7, default="0", required=True
    )
    digito_conta_corrente_pagador = CNABFieldInteger(
        "020-020", length=1, default="0", required=True
    )
    ...
    codigo_banco_debito = CNABFieldInteger(
        "063-065", length=3, default="0", required=True
    )
    codigo_multa = CNABFieldInteger("066-066", length=1, default="0", required=True)
    taxa_multa = CNABFieldDecimal(
        "067-070", length=2, default="0", precision=2, required=True
    )
    ...
    vlr_bonificacao_dia = CNABFieldDecimal(
        "083-092", length=8, default="0", precision=2, required=True
    )
    ...
    endereco_aviso_debito = CNABFieldInteger(
        "106-106", length=1, default="2", required=True
    )
    ...
    vlr_juros = CNABFieldDecimal(
        "161-173", length=11, default="0", precision=2, required=True
    )
    data_desconto = CNABFieldDate("174-179", length=6, default="0", required=True)
    vlr_desconto = CNABFieldDecimal(
        "180-192", length=11, default="0", precision=2, required=True
    )
    vlr_IOF = CNABFieldDecimal(
        "193-205", length=11, default="0", precision=2, required=True
    )
    vlr_abatimento = CNABFieldDecimal(
        "206-218", length=11, default="0", precision=2, required=True
    )
