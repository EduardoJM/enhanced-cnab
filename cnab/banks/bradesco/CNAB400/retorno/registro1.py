...
class BradescoRetornoCnab400Registro1(Registro1Retorno):
    ...
    tipo_inscricao_empresa = CNABFieldInteger("002-003", length= 2, default= '', required =True)
    numero_inscricao_empresa = CNABFieldAlfa("004-017", length= 14, default= '', required =True)
    ...
    vlr_iof_devido = CNABFieldDecimal("215-227",length= 11,default= '',precision= 2,required =True)
    vlr_abatimento = CNABFieldDecimal("228-240",length= 11,default= '',precision= 2,required =True)
    vlr_desconto = CNABFieldDecimal("241-253",length= 11,default= '',precision= 2,required =True)
    vlr_pago = CNABFieldDecimal("254-266",length= 11,default= '',precision= 2,required =True)
    vlr_juros_multa = CNABFieldDecimal("267-279",length= 11,default= '',precision= 2,required =True)
    vlr_outros = CNABFieldDecimal("280-292",length= 11,default= '',precision= 2,required =True)
    ...
    codigo_banco_cheque = CNABFieldInteger("315-318",length= 4,default= '0',required =True)
