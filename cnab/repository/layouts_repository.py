...
class LayoutsRepository:
    ...
    @classmethod
    def register_retorno(
        cls, bank_code: str, layout_code: str, retorno_class: type[Retorno]
    ):
        code = _get_layout_name(bank_code, layout_code)
        cls.RETORNOS[code] = retorno_class

    @classmethod
    def register_remessa(
        cls, bank_code: str, layout_code: str, remessa_class: type[Remessa]
    ):
        code = _get_layout_name(bank_code, layout_code)
